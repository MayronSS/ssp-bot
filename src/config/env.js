...
const env = {
  ...
  CHANNEL_AVALIACAO_PMESP: process.env.CHANNEL_AVALIACAO_PMESP || '1510831165341433917',
  CHANNEL_AVALIACAO_PCESP: process.env.CHANNEL_AVALIACAO_PCESP || '1510831166889136228',
  CHANNEL_RESULTADOS_PMESP: process.env.CHANNEL_RESULTADOS_PMESP || '1510831168151490681',
  CHANNEL_RESULTADOS_PCESP: process.env.CHANNEL_RESULTADOS_PCESP || '1510831169237815421',
  ...
  ROLE_PRE_APROVADO_PMESP: process.env.ROLE_PRE_APROVADO_PMESP || '1510829636433481734',
  ROLE_PRE_APROVADO_PCESP: process.env.ROLE_PRE_APROVADO_PCESP || '1510829667043639376',
  ROLE_CIDADAO: process.env.ROLE_CIDADAO || '1348015731933057055',
  SETUP_ALLOWED_USER_ID: process.env.SETUP_ALLOWED_USER_ID || '896063696567152671',
