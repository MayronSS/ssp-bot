...
const env = {
  ...
  CATEGORY_TICKETS: process.env.CATEGORY_TICKETS || '1510831160660590652',
  CATEGORY_CORREGEDORIA: process.env.CATEGORY_CORREGEDORIA,
  CATEGORY_EDITAL: process.env.CATEGORY_EDITAL || '1523484704295096450',
  ...
  CHANNEL_FT_PANEL: process.env.CHANNEL_FT_PANEL || '1510846517752369172',
  CHANNEL_FT_HIERARCHY: process.env.CHANNEL_FT_HIERARCHY || process.env.CHANNEL_FT_PANEL || '1510846517752369172',
