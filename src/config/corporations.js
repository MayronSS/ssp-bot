  ...
  corporations: [
    {
      ...
      ranks: [
        ...
        { name: '1º Tenente PM', shortName: '1º Ten', level: 7, emoji: '⭐' },
        { name: 'Capitão PM', shortName: 'Cap', level: 8, emoji: '🎖️' },
        { name: 'Major PM', shortName: 'Maj', level: 9, emoji: '🥉' },
        { name: 'Tenente-Coronel PM', shortName: 'TC', level: 10, emoji: '🥈' },
        { name: 'CMD Geral Coronel PM', shortName: 'Cel', level: 11, emoji: '🥇' },
      ],
