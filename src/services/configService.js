...
async function getChannel(guildId, key) {
  ...
  const fallbackMap = {
    ...
    editalAvaliacaoPmesp: process.env.CHANNEL_AVALIACAO_PMESP || env.CHANNEL_AVALIACAO,
    editalAvaliacaoPcesp: process.env.CHANNEL_AVALIACAO_PCESP || env.CHANNEL_AVALIACAO,
    editalResultadosPmesp: process.env.CHANNEL_RESULTADOS_PMESP || env.CHANNEL_RESULTADOS,
    editalResultadosPcesp: process.env.CHANNEL_RESULTADOS_PCESP || env.CHANNEL_RESULTADOS,
